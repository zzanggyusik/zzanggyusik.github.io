...
1학기 최종 발표도 얼마 안남아서 룰베이스로 대충 구현했는데 아주 마음에 안 들어서 깃허브랑 papers with code 뒤적이다가 pyABSA라는 오픈소스 프레임워크를 발견했다.
...
[ABSADatasets/datasets/apc_datasets/110.SemEval/114.restaurant14/Restaurants_Train.xml.seg]
