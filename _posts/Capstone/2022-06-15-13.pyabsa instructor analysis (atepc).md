...
PyABSA 프레임워크의 전체적인 구성은 다음과 같습니다.

<img width="688" alt="PyABSA" src="https://user-images.githubusercontent.com/76269316/177023033-22cc9f08-e9ed-421c-a66c-92db87e5791c.png" style="zoom:150%;" >

<br>

✔ configuration에 저장된 값들을 불러와 사용하는 부분이 많습니다. 어떤 값이 들어가는지 궁금하다면 아래 configuration을 참고해주세요.

<script src="https://gist.github.com/seominseok4834/713d12bdc58c9eb1511bfddf660ca175.js"></script>

코드로 올리면 이렇게 한 라인으로 나와서 캡쳐한 이미지도 같이 올렸습니다.

<img width="933" alt="스크린샷 2022-07-02 오후 4 21 17" src="https://user-images.githubusercontent.com/76269316/176990921-97ce420f-e808-4857-9d8b-50e581eae763.png">
...
#1: 실제 모델을 생성하는 부분입니다. (forward 함수가 정의된 모델)

configuration에 정의된 모델을 생성합니다.
