...
#2차원 데이터로 변환
labels = labels.reshape(-1, 1)  #8X1으로 변환
...
문자열 피처가 Sex, Cabin, Embarked 세 개가 있었는데 [마찬가지로 문자열을 허용하지 않으므로](https://seominseok4834.github.io/machine%20learning/2.scikit-learn-machine-learning-in-python/#%EB%8D%B0%EC%9D%B4%ED%84%B0-%EC%A0%84%EC%B2%98%EB%A6%AC) 이를 어떻게 처리할지 고민하기 전에, 먼저 피처들의 값 분류를 살펴보도록 하겠습니다.
