...
사이킷런 DecisionTreeClassifier를 이용해 동작 예측 분류를 수행해보겠습니다.
...
트리 깊이(Tree Depth)가 예측 정확도에 미치는 영향을 보기위해, GridSearchCV를 이용해 max_depth 값을 변화시키면서 예측 성능을 확인해보겠습니다.
...
이번에는 max_depth와 min_samples_split을 같이 변경하면서 성능을 튜닝해보겠습니다.
