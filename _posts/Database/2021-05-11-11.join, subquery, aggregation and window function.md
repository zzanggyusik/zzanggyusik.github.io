...
왜냐하면 Natural Join의 경우는 암시적으로 두 테이블의 column 이름이 같은 걸  결합하는데, 실제 현장에서는 테이블 스키마 변경이 일어날 수도 있기 때문에, Natural Join을 사용하지 못하게 합니다.
...
![image-20210511160443719](C:\Users\seominseok\AppData\Roaming\Typora\typora-user-images\image-20210511160443719.png)
