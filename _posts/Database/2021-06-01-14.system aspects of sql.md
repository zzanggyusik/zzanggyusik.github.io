...
- PostgreSQL Syntax : DECLARE name [BINARY] [INSENSITIVE] [[NO] SCROLL] CURSOR [ {WITH | WITHOUT} HOLD] FOR query
...
int main()
{
    ...
    SQLPrepare(execStat, "SELECT netWorth FROM MovieExec", SQL_NTS); //SQL 문장 초기화
    SQLExecute(execStat);
}
```
